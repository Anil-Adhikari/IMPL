...
public class StandardListIteratorTest {
	...
	public void singletonListHasOneElement() {
		...
		Iterator<Integer> iter = singletonList.getStandardIterator();
	...
	public void regularListHasCorrectElements() {
		...
		Iterator<Integer> iter = regularList.getStandardIterator();
	...
	@Test
	public void regularListStillHasDupes() {
		...
		assertEquals("The first element is 5", 5, iter.next().intValue());
		assertEquals("The second element is 1", 1, iter.next().intValue());
		assertEquals("The third element is 1", 1, iter.next().intValue());
		assertEquals("The fourth element is 1", 1, iter.next().intValue());
		assertEquals("The fifth element is 2", 2, iter.next().intValue());
		assertFalse("List has no more elements", iter.hasNext());
	}
}
